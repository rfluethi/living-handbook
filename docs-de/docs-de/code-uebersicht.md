...
- Englisch ist die Sprache des Repositories; die deutsche Quelle dieser Entwickler-Dokumentation (`docs-de/`) liegt im Arbeitsbereich des Teams. Das deutsche App-Handbuch ist die Ausnahme: es liegt im Repository, unter `handbuch/de/`.
