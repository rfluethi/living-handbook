...
<details>
<summary>Requirements: What you should know</summary>
...
![The page list with Quick Edit open, highlighting the three review fields.](../assets/quickedit-pruefung.webp)
...
* **The status filter above the page list** pulls out everything due, overdue or never reviewed with one click. Next to it sit dropdowns. They filter by handbook, page type, topic, role, audience and source. You only see the dropdowns that are of use to you: hide a column under "Screen Options" at the top right and its dropdown goes with it, and a group without a single term gets none at all. If you are currently filtering by something whose column is hidden, that dropdown stays, so you can take the filter back.
