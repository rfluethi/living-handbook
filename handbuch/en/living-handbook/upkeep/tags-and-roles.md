...
Every handbook page is classified with four tag groups: page type, topic, audience and responsible role. This guide shows where you view, extend and rename the terms of these groups.

<details>
<summary>Concept: What the four groups are for</summary>

The tags make pages findable. They produce the badges on every page and the filters on the entry page. For that to work, all authors must use the same terms. That is why the terms are maintained centrally, and while writing you only pick from them. The plugin ships starter terms for page type, audience and role. Topics you create yourself, matching your content.

</details>

## Viewing and adding terms

1. Open the **Handbook** menu. Below the divider sit the four groups: **Page types**, **Topics**, **Audiences** and **Responsibility**.
...
4. To rename or delete, hover over a term and choose **Edit** or **Delete**. On deletion, pages only lose the tag; the pages themselves remain.
...
All four groups hold the terms your handbook needs. When writing a page, they are available in the sidebar. The filters on the entry page only show terms that at least one page uses.
