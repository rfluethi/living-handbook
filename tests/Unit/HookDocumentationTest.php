...
/**
 * docs/technical/en/living-handbook-technical/hooks.md against src/.
 */
final class HookDocumentationTest extends TestCase {
	...
	/**
	 * Every hook name docs/technical/en/living-handbook-technical/hooks.md mentions.
	 *
	 * @return array<int, string>
	 */
	private function hooks_in_docs(): array {
		$path = $this->root() . '/docs/technical/en/living-handbook-technical/hooks.md';
	...
	public function test_every_hook_in_the_code_is_documented(): void {
		...
		$this->assertSame(
			array(),
			$missing,
			"These hooks exist but docs/technical/en/living-handbook-technical/hooks.md does not mention them:\n  " . implode( "\n  ", $missing )
		);
	}
	...
	public function test_nothing_is_documented_that_does_not_exist(): void {
		...
		$this->assertSame(
			array(),
			$phantom,
			"docs/technical/en/living-handbook-technical/hooks.md names these, and the code does not fire them:\n  " . implode( "\n  ", $phantom )
		);
	}
	...
	public function test_every_hook_has_a_heading_of_its_own(): void {
		$doc      = (string) file_get_contents( $this->root() . '/docs/technical/en/living-handbook-technical/hooks.md' );
		$headless = array();
